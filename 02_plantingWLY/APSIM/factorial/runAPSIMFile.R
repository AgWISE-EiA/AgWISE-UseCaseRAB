...
save(resultsFebMar, file="D:/dev_agwise/AgWISE-UseCaseRAB/02_plantingWLY/APSIM/season1_outputv1/resultsFebMar.RData")
save(resultsAugSep, file="D:/dev_agwise/AgWISE-UseCaseRAB/02_plantingWLY/APSIM/season2_outputv1/resultsAugSep.RData")
...
glimpse(PlantingDatesAugSep)

#You can also choose to save all the files together as opposed to a list
save(PlantingDatesFebMar, file="D:/dev_agwise/AgWISE-UseCaseRAB/02_plantingWLY/APSIM/season1_outputv1/PlantingDatesFebMar.RData")
save(PlantingDatesAugSep, file="D:/dev_agwise/AgWISE-UseCaseRAB/02_plantingWLY/APSIM/season2_outputv1/PlantingDatesAugSep.RData")
